...
const AllJobs = () => {
    ...
    const url = searchedValue ? `https://job-cracker-bkvg9bh4v-adriyan.vercel.app/api/v1/jobs-collection?title=${searchedValue}` : 'https://job-cracker-bkvg9bh4v-adriyan.vercel.app/api/v1/jobs-collection'
