        ...
        <>
            <form>
                <div className="flex justify-center relative">
                    ...
                    <button className="bg-gradient-to-l from-[#0FCFEC] to-[#19D3AE]  py-2 md:py-3 px-3 md:px-6 lg:px-9 text-white font-bold text-xs md:text-sm  rounded-tr-[4px] rounded-br-[4px] notched ">SEARCH</button>
                </div>
            </form>
        </>
    );
